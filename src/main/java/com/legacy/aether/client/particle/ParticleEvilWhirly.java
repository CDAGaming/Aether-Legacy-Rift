...
public class ParticleEvilWhirly extends AetherParticle
{
    ...
    @Override
    public void buildGeometry(VertexBuffer worldRendererIn, Entity entityIn, float partialTicks, float rotationX, float rotationZ, float rotationYZ, float rotationXY, float rotationXZ)
    {
