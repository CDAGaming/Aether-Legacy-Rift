...
public class GoldenAercloudStructure extends Structure<NoFeatureConfig>
{

	public GoldenAercloudStructure()
	{
	...
	public static class Start extends StructureStart
	{
		...
		{
			this.components.add(new GoldenAercloudPiece(randIn, (chunkX << 4) + 2, randIn.nextInt(64) + 96, (chunkZ << 4) + 2));
