...
public class ColdAercloudStructure extends Structure<NoFeatureConfig>
{

	public ColdAercloudStructure()
	{
	...
	public static class Start extends StructureStart
	{
		...
		{
			this.components.add(new ColdAercloudPiece(randIn, (chunkX << 4) + 2, randIn.nextInt(64) + 64, (chunkZ << 4) + 2));
