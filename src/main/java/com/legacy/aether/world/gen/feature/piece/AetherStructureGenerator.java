package com.legacy.aether.world.gen.feature.piece;
...
public abstract class AetherStructureGenerator extends StructurePiece
{
	...
	public boolean spawnEntity(Entity entity, int structureX, int structureY, int structureZ)
	{
		...
		{
			entity.setPositionAndAngles((double) posX + 0.5D, (double) posY + 0.5D, (double) posZ + 0.5D, 0.0F, 0.0F);

			if (entity instanceof LivingEntity)
			{
				LivingEntity livingEntity = ((LivingEntity) entity);

				livingEntity.heal(livingEntity.getHealthMaximum());
			}
	...
	@Override
	public boolean generate(IWorld worldIn, Random randIn, MutableIntBoundingBox boundingBoxIn, ChunkPos chunkPosIn)
	{
		this.world = worldIn;
		this.random = randIn;
