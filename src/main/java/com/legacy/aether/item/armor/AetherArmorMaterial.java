...
public class AetherArmorMaterial implements ArmorMaterial
{
    ...
    public AetherArmorMaterial(String name, int maxDamageFactor, int[] damageReductionAmountArray, int enchantability, SoundEvent soundEvent, float toughness, ItemProvider repairMaterial)
    {
        this.name = name;
