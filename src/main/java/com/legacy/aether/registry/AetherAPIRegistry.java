...
public class AetherAPIRegistry
{
	...
	public static void register()
	{
		...
		registry.register(new AetherEnchantment(ItemsAether.golden_dart, ItemsAether.enchanted_dart, 250));
		registry.register(new AetherEnchantment(ItemsAether.golden_dart_shooter, ItemsAether.enchanted_dart_shooter, 500));

		registry.register(new AetherEnchantment(ItemsAether.skyroot_poison_bucket, ItemsAether.skyroot_remedy_bucket, 1000));
		...
		registry.register(new AetherEnchantment(ItemsAether.blueberry, ItemsAether.enchanted_blueberry, 300));

		registry.register(new AetherEnchantment(Items.BOW, 4000));
		registry.register(new AetherEnchantment(Items.FISHING_ROD, 600));

		registry.register(new AetherEnchantment(Items.MUSIC_DISC_11, ItemsAether.aether_tune, 2500));
		registry.register(new AetherEnchantment(Items.MUSIC_DISC_13, ItemsAether.aether_tune, 2500));
		registry.register(new AetherEnchantment(Items.MUSIC_DISC_BLOCKS, ItemsAether.aether_tune, 2500));
		registry.register(new AetherEnchantment(Items.MUSIC_DISC_CAT, ItemsAether.aether_tune, 2500));
		registry.register(new AetherEnchantment(Items.MUSIC_DISC_FAR, ItemsAether.aether_tune, 2500));
		registry.register(new AetherEnchantment(Items.MUSIC_DISC_MALL, ItemsAether.aether_tune, 2500));
		registry.register(new AetherEnchantment(Items.MUSIC_DISC_MELLOHI, ItemsAether.aether_tune, 2500));
		registry.register(new AetherEnchantment(Items.MUSIC_DISC_STAL, ItemsAether.aether_tune, 2500));
		registry.register(new AetherEnchantment(Items.MUSIC_DISC_STRAD, ItemsAether.aether_tune, 2500));
		registry.register(new AetherEnchantment(Items.MUSIC_DISC_WAIT, ItemsAether.aether_tune, 2500));
		registry.register(new AetherEnchantment(Items.MUSIC_DISC_WARD, ItemsAether.aether_tune, 2500));
		...
		registry.register(new AetherFreezable(BlocksAether.cold_aercloud, BlocksAether.blue_aercloud, 100));
		registry.register(new AetherFreezable(BlocksAether.skyroot_leaves, BlocksAether.crystal_leaves, 150));
		registry.register(new AetherFreezable(ItemsAether.skyroot_bucket, Blocks.ICE, 500));
