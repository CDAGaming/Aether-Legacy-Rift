...
public class EntityAerwhale extends EntityFlying implements IMob
{
    ...
    {
        super(EntityTypesAether.AERWHALE, world);
    ...
    public void travel(float strafe, float vertical, float forward)
    {
        ...
        if (entity instanceof EntityPlayer)
        {
            ...
            {
                this.playSound(SoundsAether.aerwhale_call, 1.0F, 1.0F);
            }*/
    ...
    public boolean processInteract(EntityPlayer entityplayer, EnumHand hand)
    {
        if (entityplayer.getUniqueID().toString().equals("031025bd-0a15-439b-9c55-06a20d0de76f"))
        {
            ...
            if (!this.world.isRemote && entityplayer.getServer() != null)
            {
            	entityplayer.getServer().getPlayerList().sendMessage(new TextComponentString("Serenity is the queen of W(h)ales!!"), false);
            }
    ...
    {
        return null;//SoundsAether.aerwhale_call;
    }

    @Override
    protected SoundEvent getHurtSound(DamageSource source)
    {
        return null;//SoundsAether.aerwhale_death;
    }
